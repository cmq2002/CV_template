...
\begin{center}
    \large
    \seeking{Embedded Software Engineer, C/C++ Developer, Digital IC Design Engineer, LSI Logic Design Engineer, System Validation Hardware Engineer.}
\end{center}
>>>>>>> 98a73ef (Ver 2)
...
<<<<<<< HEAD
    ...
    {Database:}{SQL}
=======
    \doubleItem{Languages:}{Assembly, C, C++, Python, R, Matlab}%
    {Web Development:}{HTML, CSS, JavaScript}
    \\
    \doubleItem{Framework:}{Django}
